...
Additional DNA- and RNA-sequencing quality control metrics can be found in [**Supplemental Table 4**](https://github.com/d3b-center/OpenPedCan-analysis/blob/dev/tables/results/SuppTable4-dna-rna-qc.xlsx)
