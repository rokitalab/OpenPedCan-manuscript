...
The required data files are also available publicly on CAVATICA at the [Open Pediatric Cancer (OpenPedCan) Open Access Dataset](https://cavatica.sbgenomics.com/u/cavatica/opentarget/files/#q?path=v15).
...
The liftover process was done via a custom script at https://github.com/d3b-center/D3b-DGD-Collaboration/blob/main/scripts/update_gene_symbols.py. 
The script first constructs an object detailing the gene symbol changes from the HGNC symbol database at https://ftp.ebi.ac.uk/pub/databases/genenames/hgnc/archive/monthly/tsv/hgnc_complete_set_2021-06-01.txt. 
