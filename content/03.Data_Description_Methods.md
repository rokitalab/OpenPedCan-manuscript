...
All RNA-seq and WGS samples passed minimum quality thresholds, including ≥20 million total reads and ≥50% alignment for RNA-Seq, and ≥20X mean coverage for DNA sequencing. 
...
These include: _KIAA1549::BRAF_ fusions in low-grade gliomas, H3 K28M/I mutations in diffuse midline gliomas, H3 G35R/V mutations in diffuse hemispheric gliomas, somatic _TP53_ mutations in high-grade gliomas, and _MYCN_ amplification in neuroblastoma, for example.
...
As shown in [Table {@tbl:table2}], we observed nearly 100% concordance, validating both experimental modalities and classifier accuracy. 
...
In addition to verifying known findings, OpenPedCan modules support the discovery of novel molecular entities. 
The reproducibility of these results is further supported by their reuse across studies, Zenodo downloads, GitHub forks, and independent analysis pipelines.
...
Table: **Medulloblastoma subtype concordance across experimental strategies.** Comparison of medulloblastoma subtypes using methylation or RNA-Seq classification. {#tbl:table2}
