...
An overview of the OpenPedCan data availablity is summarized in [Table 1](#tbl:table1).

| Platform | Data Type | Access Type | Access Requirement |
|----------|----------|----------|----------|
| PedcBioPortal | Cohort, cancer group, and individual data | Query |  Gmail account |
| Molecular Targets Platform | Cancer group summary data | Query | Open Access |
| GitHub | Merged summary files | Full access | S3 download script |
| CAVATICA | Merged summary files | Full access | CAVATICA account|

{: #tbl:table1 }

**Table 1: OpenPedCan Data Availability**: OpenPedCan data is availabile on multiple platforms with varying access requirements. 
